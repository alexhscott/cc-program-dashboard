...
(async function init(){
  // Hide app, show login while we check session
  showLogin();

  // Single source of truth for auth state — onAuthStateChange handles
  // all cases: initial load, refresh, token renewal, sign out
  let _appReady = false;
